...
## DONE (S0-S100: 242 assertions, 4986+ tests, 38 Rust tests) — v0.13.0
...
## DONE (S0-S92: 242 assertions, 4986+ tests, 38 Rust tests) — v0.12.4
...
- [x] **mltk-index** — Codebase index skill (242 assertions, 11 MCP, 28 CLI, file:line pointers). Generated by `scripts/generate_skill_index.py`
