...
Speech-specific assertions for recognition accuracy (WER, CER), real-time performance (RTF), and accent fairness. Maps to Kaleidoo's speech recognition capabilities.
