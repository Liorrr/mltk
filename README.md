...
[![Tests](https://img.shields.io/badge/tests-4999%2B%20passed-green.svg)]()
...
## Feature Matrix (244 assertion definitions)
...
| LLM evaluation | No | Yes (LLM-only) | No | **Yes (50+ metrics)** | Yes (OWASP scanner) | **Yes (tracing)** | **Yes (244 assertions)** |
